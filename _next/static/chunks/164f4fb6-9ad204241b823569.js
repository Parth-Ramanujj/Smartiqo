  ...
  [3930],
  {
    26597: (t, e, r) => {
      ...
      function R(t) {
        ...
        var tY = function (t, e) {
          if (!tO[t]) {
            var r =
              (e instanceof E ? "Sh" : "P") +
              (Object.keys(tC).length + 1).toString(10);
            (e.id = r), (tO[t] = r), (tC[r] = e), tD.publish("addPattern", e);
          }
        };
        (y.ShadingPattern = E),
          (y.TilingPattern = B),
          ...
          t8 = function (t) {
            tD.publish("putFont", {
              ...
              !0 !== t.isAlreadyPutted &&
                ...
                tl("<<"),
                tl("/Type /Font"),
                tl("/BaseFont /" + C(t.postScriptName)),
                tl("/Subtype /Type1"),
            ...
            tZ(t.resourcesOid, !0),
              ...
              (function () {
                if (Object.keys(tC).length > 0) {
                  for (var t in (tl("/Shading <<"), tC))
                    tC.hasOwnProperty(t) &&
                      tC[t] instanceof E &&
                      tC[t].objectNumber >= 0 &&
                      tl("/" + t + " " + tC[t].objectNumber + " 0 R");
                  tD.publish("putShadingPatternDict"), tl(">>");
                }
              })(),
              (function (t) {
                if (Object.keys(tC).length > 0) {
                  for (var e in (tl("/Pattern <<"), tC))
                    tC.hasOwnProperty(e) &&
                      tC[e] instanceof y.TilingPattern &&
                      tC[e].objectNumber >= 0 &&
                      tC[e].objectNumber < t &&
                      tl("/" + e + " " + tC[e].objectNumber + " 0 R");
            ...
            function (t, e, r, i, a) {
              ...
              if ("[object Array]" === Object.prototype.toString.call(t)) {
                ...
                if ("right" === u) {
                  ...
                  (t = []), (j = s.length);
                  for (var Q = 0; Q < j; Q++) t.push(s[Q]);
                } else if ("justify" === u && "Identity-H" === V.encoding) {
                  (t = []), (j = s.length), (h = 0 !== h ? h : W);
                  for (var tt = 0, te = 0; te < j; te++)
                    if (
                      ((J = 0 === te ? eG(r) : -H),
                      (X = 0 === te ? eV(e) : tt),
                      te < j - 1)
        ...
        var eC = function (t, e) {
            ...
            if (n instanceof E)
              ...
              t.matrix &&
                ...
                (r = ej.call(n, t.key, t.boundingBox, t.xStep, t.yStep, i).id)),
                tl("q"),
                tl("/Pattern cs"),
                tl("/" + r + " scn"),
                n.gState && y.setGState(n.gState),
        ...
        (y.__private__.line = y.line =
          ...
          (y.setFont = function (t, e, r) {
            return (
              r && (e = F(e, r)), (tA = eh(t, e, { disableWarning: !1 })), this
            );
          });
        var eB =
        ...
        (y.addGState = function (t, e) {
          ...
          (y.saveGraphicsState = function () {
            return tl("q"), tj.push({ key: tA, size: tp, color: eZ }), this;
          }),
          (y.restoreGraphicsState = function () {
            tl("Q");
            var t = tj.pop();
            return (
              (tA = t.key), (tp = t.size), (eZ = t.color), (tE = null), this
            );
          }),
        ...
        (function (t) {
          ...
          t.table = function (t, r, u, l, h) {
            ...
            if (A) {
              ...
              var j = c.call(this, I, w);
              (N = m.map(function (e) {
                return new o(t, r, w[e], j, I[e].text, void 0, I[e].align);
              })),
            ...
            for (f = 0; f < u.length; f += 1) {
              ...
              for (p = 0; p < m.length; p += 1) {
                ...
                "cellStart" in h &&
                  ...
                  s.call(this, new o(t, r, w[m[p]], O, M, f + 2, C[m[p]]));
              }
            }
            return (
      ...
      function t0(t, e, r, n) {
        ...
        return (
          d !== n && u.log("Warning, gif stream shorter than expected."), r
        );
      }
      function t3(t) {
        var e,
            ...
            for (x = 0; x < Y; ) {
              for (D = Y * J + x, z = -1, U = 0, H = 0; H < 64; H++)
                (T = D + (U = H >> 3) * Y + (z = 4 * (7 & H))),
                  ...
                  (R = W[T++]),
                  (b[H] =
                    ((N[L] + N[(C + 256) | 0] + N[(R + 512) | 0]) >> 16) - 128),
                  (y[H] =
                    ((N[(L + 768) | 0] +
                      N[(C + 1024) | 0] +
                      N[(R + 1280) | 0]) >>
        ...
        var c = function () {
          ...
          function k(t, e) {
            ...
            for (
              ...
              (i += 8), (n >>= 8);
            return (n = 7 ^ (i + rx[n])), (t.b -= n), (t.Ca = (r << n) - 1), a;
          }
          function F(t, e, r) {
            (t[e + 0] = (r >> 24) & 255),
              (t[e + 1] = (r >> 16) & 255),
                      ...
                      for (U = 0; 5 > U; ++U) {
                        ...
                        n: {
                          ...
                          if ((i(tu, 0, 0, tb), tL)) {
                            ...
                            for (tv = 0; tv < tC; ++tv) tj[nb[tv]] = y(tN, 3);
                            var tM = void 0,
                              tq = void 0,
                              tE = 0,
                              tB = s.m,
                ...
                for (a = 0; 3 > a; ++a)
                  for (u = 0; 11 > u; ++u)
                    (h = k(s, nI[n][o][a][u]) ? g(s, 8) : nk[n][o][a][u]),
                      (c.Wc[n][o].Yb[a][u] = h);
              for (o = 0; 17 > o; ++o) c.Xc[n][o] = c.Wc[n][nj[o]];
            }
          ...
          function eO(t, e, r, n) {
            var i;
            for (i = 3; 0 < i; --i) ej(t, (e += 4 * r), r, n);
          }
          function eM(t, e, r, n) {
            var i;
            for (i = 3; 0 < i; --i) eC(t, (e += 4), r, n);
          }
          ...
          function ri(t, e, r, n, i) {
            var a = (240 & rt(t, e)) | 15;
            (n[i + 0] = (240 & e7(t, r)) | (e9(t, e, r) >> 4)), (n[i + 1] = a);
          }
              ...
              if (
                ...
                for (r = 0; 16 > r; ++r, b <<= 2)
                  (y = c),
                    ...
                    nO[p.Ob[r]](y, w),
                    rl(b, v, 16 * r, y, w);
              } else if ((nC[(y = ru(a, o, p.Ob[0]))](c, u), 0 != b))
                for (r = 0; 16 > r; ++r, b <<= 2)
              ...
              t: {
                ...
                if ((((k = d = [d])[0] = 0), 8 > y[0])) y = 7;
                  ...
                  if (!r(N, b[0], "VP8X")) {
                    ...
                    var _ = C(N, b[0] + 8),
                      P = 1 + j(N, b[0] + 12);
                    if (0x80000000 <= P * (N = 1 + j(N, b[0] + 15))) {
                      y = 3;
                      break t;
                    }
                    null != S && (S[0] = _),
              ...
              if ((w && d) || (!w && !d && !r(t, n[0], "ALPH"))) {
                ...
                t: {
                  ...
                  for (
                    ...
                    r(_, N, "ALPH") || ((L[0] = _), (A[0] = N + 8), (S[0] = I)),
                      (N += O),
                      (F -= O);
                  }
                }
          ...
          var rI,
            ...
            nj = [0, 1, 2, 3, 6, 4, 5, 6, 6, 6, 6, 6, 6, 6, 6, 7, 0],
            nC = [],
            nO = [],
            nM = [],
            nq = 1,
          ...
          if (this.autoPaging) {
            ...
            for (var F = P[0], I = P[P.length - 1], j = F; j < I + 1; j++) {
              ...
              T &&
                ...
                this.pdf
                  .rect(this.margin[3], this.margin[0], C, q, null)
                  .clip()
                  .discardPath()),
          ...
          j = function (t) {
            ...
            if (this.autoPaging) {
              ...
              for (var L = v[0], P = v[v.length - 1], k = L; k < P + 1; k++) {
                ...
                if (R || B.y + B.h <= j) {
                  if (R || (B.y >= F && B.x <= O)) {
                    ...
                    z &&
                      (this.pdf.saveGraphicsState(),
                      this.pdf
                        .rect(this.margin[3], this.margin[0], M, C, null)
                        .clip()
                        .discardPath()),
                ...
                } else B.y < j && (this.ctx.prevPageLastElemOffset += j - B.y);
                t.scale >= 0.01 &&
          ...
          function e() {
            return (
              s.html2canvas
                ...
                : Promise.resolve().then(r.t.bind(r, 52699, 23))
            )
              .catch(function (t) {
        ...
        (R.API.addSvgAsImage = function (t, e, n, i, a, o, c, l) {
          ...
          return (
            s.canvg
              ...
              : Promise.all([r.e(501), r.e(1823), r.e(8255)]).then(
                  r.bind(r, 34137),
                )
          )
            .catch(function (t) {
